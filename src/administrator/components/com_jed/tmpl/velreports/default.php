...
/** @var \Jed\Component\Jed\Administrator\View\Velreports\HtmlView $this */
/**
 * @package JED
 *
 * @subpackage VEL
...
if ($saveOrder) {
    ...
    HTMLHelper::_('sortablelist.sortable', 'velreportList', 'adminForm', strtolower((string) $listDirn), $saveOrderingUrl);
}

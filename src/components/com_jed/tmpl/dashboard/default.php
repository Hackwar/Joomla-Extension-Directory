...
<div class="com-jed-dashboard">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo Route::_('index.php?option=com_jed&view=extensionform'); ?>" class="btn btn-primary btn-sm">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo Route::_('index.php?option=com_jed&view=ticketform'); ?>" class="btn btn-primary btn-sm">
